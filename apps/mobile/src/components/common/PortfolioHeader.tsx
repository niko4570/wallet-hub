...
const PortfolioHeader: React.FC<PortfolioHeaderProps> = ({ totalValueUSD, change24hPercent }) => {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.content}>
        ...
        <Text style={[styles.changePercent, { color: getChangeColor(change24hPercent) }]}>
